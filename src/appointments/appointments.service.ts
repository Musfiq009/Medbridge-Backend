...
@Injectable()import { ForbiddenException, Injectable, NotFoundException } from '@nestjs/common';
import { InjectRepository } from '@nestjs/typeorm';
import { Cron, CronExpression } from '@nestjs/schedule';
import { Between, Repository } from 'typeorm';
...
export class AppointmentsService {
  ...
  /** reschedule/cancel - doctor, CHW who scheduled, or owning patient */
  ...
  /** daily reminder cron - at most once per appointment */
